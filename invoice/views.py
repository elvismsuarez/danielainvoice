...
# ### Start Getting the data for the plots
# ## PLOT 1 - INVOICE STATUS
...
#     dataOverdue=[]
#     dataPaid=[]
#     invoice1 = Invoice.objects.filter(date_created__range=(history3, today)).count()
#     overdue1 = Invoice.objects.filter(status='OVERDUE', date_created__range=(history3, today)).count()
#     paid1 = Invoice.objects.filter(status='PAID', date_created__range=(history3, today)).count()
#     values.append(invoice1)
#     dataInvoices.append(invoice1)
#     dataOverdue.append(overdue1)
#     dataPaid.append(paid1)

#     invoice2 = Invoice.objects.filter(date_created__range=(history3, history2)).count()
#     overdue2 = Invoice.objects.filter(status='OVERDUE', date_created__range=(history3, history2)).count()
#     paid2 = Invoice.objects.filter(status='PAID', date_created__range=(history3, history2)).count()
#     #values.append(returnMonth(history2.month))
#     dataInvoices.append(invoice2)
#     dataOverdue.append(overdue2)
#     dataPaid.append(paid2)

#     invoice3 = Invoice.objects.filter(date_created__range=(history2, history1)).count()
#     overdue3 = Invoice.objects.filter(status='OVERDUE', date_created__range=(history2, history1)).count()
#     paid3 = Invoice.objects.filter(status='PAID', date_created__range=(history2, history1)).count()
#     #values.append(returnMonth(history2.month))
#     dataInvoices.append(invoice3)
#     dataOverdue.append(overdue3)
#     dataPaid.append(paid3)

#     invoice4 = Invoice.objects.filter(date_created__range=(history1, today)).count()
#     overdue4 = Invoice.objects.filter(status='OVERDUE', date_created__range=(history1, today)).count()
#     paid4 = Invoice.objects.filter(status='PAID', date_created__range=(history1, today)).count()
#     #values.append(returnMonth(history2.month))
#     dataInvoices.append(invoice4)
#     dataOverdue.append(overdue4)
#     dataPaid.append(paid4)

#     context['values'] = values
#     context['dataInvoices'] = dataInvoices
#     context['dataOverdue'] = dataOverdue
#     context['dataPaid'] = dataPaid
