...
SECRET_KEY = 'django-insecure-yn^g$m!p@y-yh%p52)b@xodg#^06ao544vf%(#9ycrwqrwvl7%'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'elvissuarez.t2r@gmail.com'
EMAIL_HOST_PASSWORD = 'skox yezn qdfd scgw'
DEFAULT_FROM_EMAIL = 'elvissuarez.t2r@gmail.com'
